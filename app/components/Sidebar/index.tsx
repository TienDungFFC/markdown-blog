...
export default function Sidebar() {
  ...
  return (
    <>
      <aside className="hidden fixed top-0 bottom-0 left-0 z-20 w-16 bg-gradient-to-b from-gray-200 to-white transition-all duration-300 lg:sticky lg:w-80 lg:shrink-0 lg:flex lg:flex-col lg:justify-end lg:items-end 2xl:max-w-[30rem] 2xl:w-full dark:from-dark-800 dark:to-dark-700 h-[100vh]">
                  ...
                  {post.childPost && post.childPost.length > 0 && (
                    <ul className="">
                      {post.childPost.map((cPost, i) => (
                        <li key={i} className="list-none hover:bg-gray-300 hover:font-semibold">
                          <ActiveLink
                            href={cPost.nameFile}
